...
class Loading(QWidget):
    def __init__(self, parent, centerOnParent=True, disableParentWhenSpinning=True, modality=Qt.ApplicationModal): #Qt.NonModal
        super().__init__(parent)
        self._centerOnParent = centerOnParent
        self._disableParentWhenSpinning = disableParentWhenSpinning

        # WAS IN initialize()
        self._color = QColor(2, 168, 186)
    ...
    def delayed_start(self, interval=1):
